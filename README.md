...
- [Financial Solver & Capital Budgeting Model](#financial-solver--capital-budgeting-model)
- [Kitchen Inventory Management Tracker](#kitchen-inventory-management-tracker)
...
- Investment evaluation via NPV and IRR
- Discounted cash flow (DCF) modeling
- Revenue and expense forecasting with depreciation schedules

[⬆ Back to top](#jump-to-a-project)
...
**Highlights:**
- Expected vs. current inventory tracking with automatic variance calculation
- Item condition logging
- Notes field for audit context
- Built for repeatable, efficient inventory audits
...
**Highlights:**
- 12 monthly sheets (income, bills, transactions log, savings/investments)
- Automatic 50/30/20 or 70/20/10 budget-split calculations
- Yearly Overview dashboard that pulls totals from every month automatically
- Category-level spending breakdowns (Rent, Groceries, Gas, Dining Out, Shopping, Subscriptions, etc.)
